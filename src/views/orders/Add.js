...
export default function Add() {
    ...
    function handleSubmit(event) {
        ...
        arr.push({name : name, price : price, notes : notes});
    ...
    return (
        <Container fluid className="main-content-container px-4">
            <Row noGutters className="page-header py-4">
                <PageTitle title="Add Order" md="12" className="ml-sm-auto mr-sm-auto" />
            </Row>
            <Row>
                <Col lg="12">
                                ...
                                <Row>
                                    <Col>
                                        <Form onSubmit={handleSubmit}>
                                            ...
                                            <Button id="submit" className="btn btn-primary mr-2" theme="accent">Submit</Button>
